...
const (
	BankService_GetCurrentBalance_FullMethodName     = "/bank.v1.BankService/GetCurrentBalance"
	BankService_FetchExchangeRates_FullMethodName    = "/bank.v1.BankService/FetchExchangeRates"
	BankService_SummarizeTransactions_FullMethodName = "/bank.v1.BankService/SummarizeTransactions"
	BankService_TransferMultiple_FullMethodName      = "/bank.v1.BankService/TransferMultiple"
	BankService_Unimplemented_FullMethodName         = "/bank.v1.BankService/Unimplemented"
)
...
type BankServiceClient interface {
	...
	Unimplemented(ctx context.Context, in *CurrentBalanceRequest, opts ...grpc.CallOption) (*CurrentBalanceResponse, error)
}
...
func (c *bankServiceClient) TransferMultiple(ctx context.Context, opts ...grpc.CallOption) (BankService_TransferMultipleClient, error) {
	...
	x := &bankServiceTransferMultipleClient{ClientStream: stream}
	return x, nil
}
...
func (c *bankServiceClient) Unimplemented(ctx context.Context, in *CurrentBalanceRequest, opts ...grpc.CallOption) (*CurrentBalanceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CurrentBalanceResponse)
	err := c.cc.Invoke(ctx, BankService_Unimplemented_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BankServiceServer interface {
	...
	Unimplemented(context.Context, *CurrentBalanceRequest) (*CurrentBalanceResponse, error)
...
func (UnimplementedBankServiceServer) Unimplemented(context.Context, *CurrentBalanceRequest) (*CurrentBalanceResponse, error) {
...
func _BankService_TransferMultiple_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(BankServiceServer).TransferMultiple(&bankServiceTransferMultipleServer{ServerStream: stream})
}
...
func _BankService_Unimplemented_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CurrentBalanceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BankServiceServer).Unimplemented(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BankService_Unimplemented_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BankServiceServer).Unimplemented(ctx, req.(*CurrentBalanceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BankService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _BankService_Unimplemented_Handler,
		},
	},
